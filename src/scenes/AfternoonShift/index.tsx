...
const AfternoonShiftScreen = () => {
  const {teacherId} = useAuth();
  const {calendar, getCalendarList, getCalendarByDay, getCalendarInDay} =
    useCalendar();
...
export default AfternoonShiftScreen;
