...
const SubjectRegistered: React.FC<SubjectDetailProps> = ({
  credit,
  typeStudy,
  name,
  detail,
  ...
  return (
    <View style={styles.wrapper}>
      <View style={styles.container}>
        <View>
          <Text style={styles.textContent}>Phòng học</Text>
          <Text style={styles.textContent}>Ngày bắt đầu</Text>
          <Text style={styles.textContent}>Ngày kết thúc</Text>
        </View>
        <View>
...
export default SubjectRegistered;
